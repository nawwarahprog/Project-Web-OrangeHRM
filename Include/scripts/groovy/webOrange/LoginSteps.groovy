...
class LoginSteps {
	...
	def verifyHomePage(){
		WebUI.verifyElementPresent(findTestObject('Object Repository/Login/Page_OrangeHRM/b_Dashboard'), 5)
		WebUI.closeBrowser()
	}

	@Then("Alert user Invalid Account")
	def verifyPage() {
		WebUI.verifyElementPresent(findTestObject('Object Repository/Login/Page_OrangeHRM/span_Invalid credentials'), 3)
	}
}